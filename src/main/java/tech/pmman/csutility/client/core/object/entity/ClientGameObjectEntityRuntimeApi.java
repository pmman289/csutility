...
import static tech.pmman.csutility.client.core.object.entity.ClientGameObjectEntityRuntime.*;

public class ClientGameObjectEntityRuntimeApi {
    /**
     * 调用这个方法来将自己标记为失效
     *
     * @param gameObject 传入this
     */
    public static void unregister(GameObjectWithEntity gameObject) {
